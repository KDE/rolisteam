...
SetPropertyOnCharactersCommand::SetPropertyOnCharactersCommand(QString idProperty, QString value, QString formula,
                                                               CharacterSheetModel* model, QUndoCommand* parent)
