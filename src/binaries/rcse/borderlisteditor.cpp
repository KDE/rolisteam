...
BorderListEditor::BorderListEditor(QObject* widget) : QStyledItemDelegate(widget)
{
...
QWidget* BorderListEditor::createEditor(QWidget* parent, const QStyleOptionViewItem& option,
